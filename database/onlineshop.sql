...
(14, 2, 6, 'Casual ', 1400, 'girl dress', 'download.jpg', 'ladies cloths girl'),
...
(38, 6, 4, 'Microwave Oven', 3500, 'Microwave Oven', 'product_images/other_20130522_microwaves_mkf.jpg', 'Microwave Oven'),
...
UPDATE `products` SET `product_image` = 'product_images/other_20130522_microwaves_mkf.jpg' WHERE `products`.`product_id` = 38
